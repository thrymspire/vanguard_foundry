#!/usr/bin/env bash
# ==============================================================================
# VANGUARD FOUNDRY // UNIVERSAL LINUX ENVIRONMENT SETUP ENGINE
...
echo -e "${C_BRIGHT}${C_BOLD}        VANGUARD FOUNDRY // LINUX ENVIRONMENT PROVISIONER${C_RESET}"
...
#!/usr/bin/env bash
# ==============================================================================
# VANGUARD FOUNDRY // LINUX RUNTIME ENVIRONMENT SPECIFICATION
...
echo ""
echo -e "${C_SIGNAL}=======================================================================${C_RESET}"
echo -e "${C_BIO}${C_BOLD} [+] VANGUARD FOUNDRY LINUX ENVIRONMENT READY!${C_RESET}"
echo -e "${C_SIGNAL}-----------------------------------------------------------------------${C_RESET}"
